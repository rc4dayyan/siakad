...
<div class="me-1 mb-1 d-inline-block">
    <form action="{{ route($prefix.'services.convert.import-gedung') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal fade text-left w-100" id="importGedung" tabindex="-1" role="dialog"
            aria-labelledby="importGedungLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="importGedungLabel">Import Data Gedung</h4>
                        <div>
                    ...
                    <div class="modal-body">
                        <p class="text-muted">
                            Gunakan hasil export sebagai template. Kolom wajib: Kode Gedung dan Nama Gedung. Kode yang sudah ada akan dilewati.
                        </p>
                        <div class="form-group">
                            <label for="import_gedung">Import Files (xlsx, csv)</label>
                            <input type="file" name="import" id="import_gedung" class="form-control" accept=".xlsx,.csv" required>
                            @error('import')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
