        ...
        <div class="col-xl-7">
            <div class="card dashboard-panel">
                ...
                <div class="card-body pt-2">
                    ...
                    <a href="{{ route($prefix.'master.penawaran-index') }}" class="dashboard-list-item"><span class="dashboard-list-item__icon {{ $academic['offeringsWithoutSchedule'] > 0 ? 'is-gold' : '' }}"><i class="fas fa-calendar-xmark"></i></span><span><strong>{{ number_format($academic['offeringsWithoutSchedule']) }} penawaran belum dijadwalkan</strong><small>Lengkapi jadwal mingguan mata kuliah</small></span><i class="fas fa-chevron-right"></i></a>
