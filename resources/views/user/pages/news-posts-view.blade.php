...
<link href="{{ asset('dist') }}/assets/extensions/normalize/normalize.min.css" rel="stylesheet">
<link href="{{ asset('dist') }}/assets/extensions/wangeditor/style.css" rel="stylesheet">
