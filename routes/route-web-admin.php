...
Route::group(['prefix' => 'web-admin', 'middleware' => ['user-access:Web Administrator'], 'as' => 'web-admin.'],function(){
    ...
    Route::middleware(['is-active:1'])->group(function () {
        ...
        Route::post('/persiapan-akademik-baru/sinkronkan-dosen-wali', [App\Http\Controllers\Admin\AcademicPreparationController::class, 'synchronizeAcademicAdvisors'])->name('academic-preparation.academic-advisors.synchronize');
        ...
        Route::post('/persiapan-akademik-baru/generate-pertemuan', [App\Http\Controllers\Admin\AcademicPreparationController::class, 'generateScheduleMeetings'])->name('academic-preparation.meetings.generate');
        ...
        Route::get('/workers/data-dosen/export',[App\Http\Controllers\Admin\Pages\WorkersController::class, 'exportLecture'])->name('workers.lecture-export');
        ...
        Route::post('/finance/data-tagihan/{code}/prepare',[App\Http\Controllers\Admin\Pages\Finance\GenerateTagihanController::class, 'prepare'])->name('finance.tagihan-prepare');
        ...
        Route::patch('/finance/billing-period/templates/{template}', [App\Http\Controllers\Admin\Pages\Finance\PeriodBillingController::class, 'update'])->name('billing-period.update');
        ...
        Route::delete('/finance/billing-period/templates/{template}', [App\Http\Controllers\Admin\Pages\Finance\PeriodBillingController::class, 'destroy'])->name('billing-period.destroy');
