...
class MasterMataKuliahSeeder extends Seeder
{
    ...
    /** Kode tambahan sesuai daftar mata kuliah PBA, termasuk nol pada kode. */
    private const ADDITIONAL_PBA_COURSES = [
        ['PGBA011', 'Filsafat Umum', 2, 2],
        ['PGBA018', 'Nahwu I', 2, 2],
        ['PGBA033', "Maharah Al Istima'", 2, 4],
        ['PGBA049', 'Lughah Al Jaraid Walmajalah', 2, 6],
        ['PGBA053', "Qiro'ah Al Kutub", 2, 6],
    ];
    ...
    public static function rows(): array
    {
        ...
        foreach (self::ADDITIONAL_PBA_COURSES as [$code, $name, $sks, $semester]) {
            $rows[] = [
                'program_studi' => '88204',
                'code' => $code,
                'name' => $name,
